...
public class OtherConfigFileType extends LanguageFileType implements FileTypeIdentifiableByVirtualFile {
  ...
  public boolean isMyFileType(VirtualFile file) {
    ...
    for (Project project : projects) {
      ...
      for (RunConfiguration runConfiguration : runConfigurations) {
        if (runConfiguration instanceof JSTestDriverConfiguration) {
          JSTestDriverConfiguration jsTestDriverConfiguration = (JSTestDriverConfiguration) runConfiguration;
          File targetIOFile = new File(jsTestDriverConfiguration.getSettingsFile());
  ...
  public String getDescription() {
    return "JsTestDriver config file referred by Run Configuration";
  }
